...
export default function Dashboard() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const revenue = await mockApiService.getRevenueData(STORE_ID, startDate, endDate);
        ...
        const productsData = await mockApiService.getProductPerformance(STORE_ID);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <KPICard
          ...
          value={kpiData ? formatCurrency(kpiData.averageOrderValue) : "Loading..."}
      ...
      {/* Sales Breakdown */}
      {salesData && <SalesBreakdown data={salesData} isLoading={isLoadingSales} />}
    </div>
  );
  ...
  const renderCustomers = () => (
    <div className="space-y-6">
      {customerData && <CustomerInsights data={customerData} isLoading={isLoadingCustomers} />}
    </div>
  );
